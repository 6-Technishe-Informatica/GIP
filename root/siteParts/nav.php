<nav>
    ...
    <ul>
        ...
        <li class="nav-item" ><a href="../pages/signup.php" class="underline-hover-effect">Registreer</a></li>
        <li class="nav-item" ><a href="../pages/login.php" class="underline-hover-effect">Log in</a></li>
